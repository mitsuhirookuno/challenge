...
describe UsersController do
  ...
  let(:valid_attributes) { { "username" => "MyString", "email" => "aaa@bbb.ccc", "password" => "MyString", "password_confirmation" => "MyString"  } }

  # This should return the minimal set of values that should be in the session
  # in order to pass any filters (e.g. authentication) defined in
  # UsersController. Be sure to keep this updated too.
  let(:valid_session) { { 'user_id' => "1000" } }

  before(:each) do
    User.create!( "id" => "1000", "username" => "MyString", "email" => "spec@spec.spec", "password" => "MyString", "password_confirmation" => "MyString" )
  end
